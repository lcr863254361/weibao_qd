...
public class PageBean implements Serializable{
	...
	private int rows = 25;//分页大小
	private int page = 1;//当前页数
	private boolean isFirstPage = false;//是否为第�?�?
	private boolean isEndPage = false;//是否为最后一�?
	private String sort;
	private String order;
	private List<Criterion> criterions = new ArrayList<Criterion>();
	private List<Order> orders = new ArrayList<Order>();
	//只在使用HQL语句查询时才会生�?
	private Object[] hqlParams = null;
	...
	public Object getExampleFilter() {
		return exampleFilter;
	}

	public void setExampleFilter(Object exampleFilter) {
