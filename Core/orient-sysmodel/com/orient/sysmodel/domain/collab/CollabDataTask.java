 ...
 */
@Entity
@Table(name = "COLLAB_DATATASK")
public class CollabDataTask {


    public static String  STATS_NOTIFY = "notify";      //已经发出通知
    public static String  STATS_ACCEPTED = "accepted";  //已经接受,正在处理
    public static String  STATS_COMPLETED = "completed";  //已经完成
    ...
    @GenericGenerator(name = "sequence", strategy = "sequence", parameters = {@Parameter(name = "sequence", value = "SEQ_COLLAB_DATATASK")})
    public String getId() {
        return id;
    }
    ...
    public boolean equals(Object o) {
        ...
        CollabDataTask that = (CollabDataTask) o;
