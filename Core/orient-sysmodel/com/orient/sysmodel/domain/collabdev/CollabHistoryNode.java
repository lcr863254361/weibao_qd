...
/**
 * @Description 抽象中介-历史节点表
 * @Author GNY
 * @Date 2018/7/26 20:21
 * @Version 1.0
 **/
@Entity
@Table(name = "CB_SYS_NODE_HIS")
public class CollabHistoryNode {
    ...
    public CollabNode getBelongNode() {
        return belongNode;
    }

    public void setBelongNode(CollabNode belongNode) {
