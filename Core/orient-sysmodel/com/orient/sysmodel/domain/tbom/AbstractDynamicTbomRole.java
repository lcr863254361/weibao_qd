...
public abstract class AbstractDynamicTbomRole extends
	 ...
	 */
	public AbstractDynamicTbomRole() {
	}

	public AbstractDynamicTbomRole(String nodeId, String roleId, String dataSource)
	{
		super();
		this.nodeId = nodeId;
		this.roleId = roleId;
