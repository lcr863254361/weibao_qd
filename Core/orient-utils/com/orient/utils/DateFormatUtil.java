...
public class DateFormatUtil {
     ...
     * yyyy-MM-dd 时间格式
     */
    public static final DateFormat DATE_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_DATE);
    /**
     * yyyy-MM-dd HH:mm:ss 时间格式
     */
    public static final DateFormat DATETIME_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_DATETIME);
    /**
     * yyyy-MM-dd HH:mm 时间格式
     */
    public static final DateFormat DATETIME_NOSECOND_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_DATETIME_NOSECOND);
    /**
     * HH:mm:ss 时间格式
     */
    public static final DateFormat TIME_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_TIME);
    /**
     * HH:mm 时间格式
     */
    public static final DateFormat TIME_NOSECOND_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_TIME_NOSECOND);
    /**
     * yyyy-MM-dd HH:mm:ss.SSS 时间格式
     */
    public static final DateFormat TIMESTAMP_FORMAT = new SimpleDateFormat(StringPool.DATE_FORMAT_TIMESTAMP);
