...
import com.orient.jpdl.model.State;
...
public class StateDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StateDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _stateChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.orient.jpdl.model.StateChoice.class, "_stateChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    State target = (State) object;
                    target.setStateChoice( (com.orient.jpdl.model.StateChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.orient.jpdl.model.StateChoice();
            }
        };
        desc.setSchemaType("com.orient.jpdl.model.StateChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.orient.jpdl.model.descriptors.StateChoiceDescriptor());
        desc.setNameSpaceURI("http://jbpm.org/4.4/jpdl");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _stateChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.orient.jpdl.model.State.class;
    }
