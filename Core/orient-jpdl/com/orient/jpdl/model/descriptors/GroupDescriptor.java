...
import com.orient.jpdl.model.Group;
...
public class GroupDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GroupDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _groupChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.orient.jpdl.model.GroupChoice.class, "_groupChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Group target = (Group) object;
                    target.setGroupChoice( (com.orient.jpdl.model.GroupChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.orient.jpdl.model.GroupChoice();
            }
        };
        desc.setSchemaType("com.orient.jpdl.model.GroupChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.orient.jpdl.model.descriptors.GroupChoiceDescriptor());
        desc.setNameSpaceURI("http://jbpm.org/4.4/jpdl");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _groupChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.orient.jpdl.model.Group.class;
    }
