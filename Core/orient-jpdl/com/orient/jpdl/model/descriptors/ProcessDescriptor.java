...
public class ProcessDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProcessDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _processChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.orient.jpdl.model.ProcessChoice.class, "_processChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Process target = (Process) object;
                return target.getProcessChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Process target = (Process) object;
                    target.setProcessChoice( (com.orient.jpdl.model.ProcessChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.orient.jpdl.model.ProcessChoice();
            }
        };
        desc.setSchemaType("com.orient.jpdl.model.ProcessChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.orient.jpdl.model.descriptors.ProcessChoiceDescriptor());
        desc.setNameSpaceURI("http://jbpm.org/4.4/jpdl");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _processChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        //-- _migrateInstances
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.orient.jpdl.model.MigrateInstances.class, "_migrateInstances", "migrate-instances", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Process target = (Process) object;
                return target.getMigrateInstances();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Process target = (Process) object;
                    target.setMigrateInstances( (com.orient.jpdl.model.MigrateInstances) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.orient.jpdl.model.MigrateInstances();
            }
        };
        desc.setSchemaType("com.orient.jpdl.model.MigrateInstances");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://jbpm.org/4.4/jpdl");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _migrateInstances
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.orient.jpdl.model.Process.class;
    }
