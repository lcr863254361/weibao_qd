...
import com.orient.jpdl.model.Rules;
...
public class RulesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RulesDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _rulesChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.orient.jpdl.model.RulesChoice.class, "_rulesChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Rules target = (Rules) object;
                    target.setRulesChoice( (com.orient.jpdl.model.RulesChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.orient.jpdl.model.RulesChoice();
            }
        };
        desc.setSchemaType("com.orient.jpdl.model.RulesChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.orient.jpdl.model.descriptors.RulesChoiceDescriptor());
        desc.setNameSpaceURI("http://jbpm.org/4.4/jpdl");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _rulesChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.orient.jpdl.model.Rules.class;
    }
