...
public class End implements java.io.Serializable {
     ...
     * Field _ends.
     */
    private com.orient.jpdl.model.types.EndEndsType _ends = com.orient.jpdl.model.types.EndEndsType.fromValue("process-instance");

    /**
     * Specify the end state of the execution explicitly.
     */
    private java.lang.String _state = "ended";
    ...
    public End() {
        super();
        setEnds(com.orient.jpdl.model.types.EndEndsType.fromValue("process-instance"));
        setState("ended");
     ...
     */
    public com.orient.jpdl.model.types.EndEndsType getEnds(
    ) {
        return this._ends;
    }
     ...
     * the following description: Specify the end state of the
     ...
     */
    public void setEnds(
            final com.orient.jpdl.model.types.EndEndsType ends) {
        this._ends = ends;
    }
     ...
     * following description: Specify the end state of the
     * execution explicitly.
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.orient.jpdl.model.End
     */
    public static com.orient.jpdl.model.End unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.orient.jpdl.model.End) org.exolab.castor.xml.Unmarshaller.unmarshal(com.orient.jpdl.model.End.class, reader);
    }
