 ...
 */
public class ProjectCRUDVersionMng extends AbstructCRUDVersionMng {

    public ProjectCRUDVersionMng(IVersionModifyer versionModifyer) {
    ...
    public void doUpdate(IBusinessModel bm, Map<String, String> dataMap, String dataId) {
        super.versionModifyer.influentByUpdate(bm, dataMap, dataId, CollabDevConstants.NODE_TYPE_PRJ);
    }

    @Override
    public void doDelete(IBusinessModel bm, String dataIds) {
        super.versionModifyer.influentByDelete(bm, dataIds, CollabDevConstants.NODE_TYPE_PRJ);
    }
}
