 ...
 */
public class PlanCRUDVersionMng extends AbstructCRUDVersionMng {

    public PlanCRUDVersionMng(IVersionModifyer versionModifyer) {
    ...
    public void doUpdate(IBusinessModel bm, Map<String, String> dataMap, String dataId) {
        super.versionModifyer.influentByUpdate(bm, dataMap, dataId, CollabDevConstants.NODE_TYPE_PLAN);
    }

    @Override
    public void doDelete(IBusinessModel bm, String dataIds) {
        super.versionModifyer.influentByDelete(bm, dataIds, CollabDevConstants.NODE_TYPE_PLAN);
    }
}
