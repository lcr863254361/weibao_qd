 ...
 */
public class RollbackNode implements INode<String, NodeState>, StateChangeListener<String, NodeState> {
    private String id;
    ...
    public NodeState stateChange(Set<INode<String, NodeState>> upNodes, INode<String, NodeState> fromNode) {
        ...
        if (CollectionUtil.isNullOrEmpty(upStates) || (upStates.size() == 1 && new NodeState(NodeState.TS_NEW, NodeState.AS_VALID).equals(CollectionUtil.first(upStates)))) {
