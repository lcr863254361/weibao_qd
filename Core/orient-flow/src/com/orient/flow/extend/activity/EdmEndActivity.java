 ...
 * @see
 */
public class EdmEndActivity  extends JpdlActivity {
  ...
  public void execute(ExecutionImpl execution) {
    ...
    if ( (parentActivity!=null)
      ...
      List<FlowTaskExecutionEventListener> flowTaskExecutionEventListeners = FlowTaskExecutionEventListenerMng.getInstance()
              .getListenersForTask(executionToEnd.getProcessInstance().getId(), executionToEnd.getProcessDefinition().getName(), FlowTaskExecutionEventListener.FLOW_END);
