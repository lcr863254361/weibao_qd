...
class ApplicationAttributeImpl extends ApplicationAttributePOA {
    ...
    static {
        ...
        obligatoryAttributes.put("meaning_of_aliases", Arrays.asList("AoEnvironment"));
        obligatoryAttributes.put("entity_name", Arrays.asList("AoNameMap", "AoAttributeMap"));
        obligatoryAttributes.put("alias_names", Arrays.asList("AoNameMap", "AoAttributeMap"));
        ...
        obligatoryAttributes.put("filename_url", Arrays.asList("AoExternalComponent"));
    ...
    public void setEnumerationDefinition(EnumerationDefinition enumDef) throws AoException {
        ...
        if (dataType != DataType.DT_ENUM && dataType != DataType.DS_ENUM) {
            throw new AoException(ErrorCode.AO_INVALID_DATATYPE, SeverityFlag.ERROR, 0,
                                  "DataTypeEntity is not DT_ENUM or DS_ENUM");
        }
        // check for equality
