...
public class AtfxTagConstants {
     ...
     * BaseElement Tag
     */
    public static final String BASE_ELEM_AOENVIMENT = "AoEnvironment";
    public static final String BASE_ELEM_AOTest = "AoTest";
    public static final String BASE_ELEM_AOSubTest = "AoSubTest";
    public static final String BASE_ELEM_AOMeasurement = "AoMeasurement";
    public static final String BASE_ELEM_AOMeasurementQuantity = "AoMeasurementQuantity";
    public static final String BASE_ELEM_AOSubMatrix = "AoSubmatrix";
    public static final String BASE_ELEM_AOLocalColumn = "AoLocalColumn";
    public static final String BASE_ELEM_AOExternalComponent = "AOExternalComponent";


    /**
     * Orient Application Model Tag
     */
    public static final String ORIENT_ELEM_AOENVIMENT = "ORIENT_Environment";
    public static final String ORIENT_ELEM_AOTest = "ORIENT_Project";
    public static final String ORIENT_ELEM_AOUnit = "ORIENT_Unit";
    public static final String ORIENT_ELEM_AOSubTest = "ORIENT_Test";
    public static final String ORIENT_ELEM_AOMeasurement = "ORIENT_MeaResult";
    public static final String ORIENT_ELEM_AOMeasurementQuantity = "ORIENT_MeaQuantity";
    public static final String ORIENT_ELEM_AOSubMatrix = "ORIENT_SubMatrix";
    public static final String ORIENT_ELEM_AOLocalColumn = "ORIENT_LocalColumn";
    public static final String ORIENT_ELEM_AOExternalComponent = "ORIENT_ExternalComponent";
    public static final String ORIENT_ELEM_AOModelColumnMeta = "ORIENT_ModelColumnMeta";
