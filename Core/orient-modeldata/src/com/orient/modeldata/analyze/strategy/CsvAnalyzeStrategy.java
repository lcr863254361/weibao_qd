...
import com.orient.modeldata.analyze.config.CsvAnalyzeConfig;
import com.orient.modeldata.analyze.parser.CsvParser;
 ...
 */
public class CsvAnalyzeStrategy extends AnalyzeStrategy {

    public CsvAnalyzeStrategy(CsvAnalyzeConfig config) {
        super(config);
        this.setParser(new CsvParser(this.getFile()));
