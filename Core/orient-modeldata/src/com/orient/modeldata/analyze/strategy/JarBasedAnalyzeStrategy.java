...
import com.orient.modeldata.analyze.config.JarBasedAnalyzeConfig;
import com.orient.modeldata.analyze.parser.JarBasedParser;
 ...
 */
public class JarBasedAnalyzeStrategy extends AnalyzeStrategy {
    private JarFile jarFile = null;

    public JarBasedAnalyzeStrategy(JarBasedAnalyzeConfig config) {
        super(config);
        this.jarFile = config.getJarFile();
        this.setParser(new JarBasedParser(this.getFile(), this.jarFile));
