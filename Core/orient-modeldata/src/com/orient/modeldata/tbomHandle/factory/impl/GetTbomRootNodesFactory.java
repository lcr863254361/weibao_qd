 ...
 */
public class GetTbomRootNodesFactory implements StragetyFactory{

    @Override
    public TbomNodeStrategy createTbomNodeStrategy() {
        return (TbomNodeStrategy)OrientContextLoaderListener.Appwac.getBean("getTbomRootNodesStrategy");
    }
}
