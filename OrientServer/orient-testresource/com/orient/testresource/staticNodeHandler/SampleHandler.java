 ...
 */
@StaticNodeModel(tbomName="试验样品管理", order=5)
public class SampleHandler implements AddStaticNodeModel {
    ...
    public IBusinessModel getBusinessModel() {
        ...
        IBusinessModel bm = businessModelService.getBusinessModelBySName("T_SYYP", schemaId, EnumInter.BusinessModelEnum.Table);
        return bm;
    }

    @Override
    public String getTemplateName() {
        return TestResourceMgrConstants.TPL_SYYP;
    }
