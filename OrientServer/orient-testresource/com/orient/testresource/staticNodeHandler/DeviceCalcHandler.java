 ...
 */
@StaticNodeModel(tbomName="设备计量管理", order=3)
public class DeviceCalcHandler implements AddStaticNodeModel {
    ...
    public IBusinessModel getBusinessModel() {
        ...
        IBusinessModel bm = businessModelService.getBusinessModelBySName("T_JLSB", schemaId, EnumInter.BusinessModelEnum.Table);
        return bm;
    }

    @Override
    public String getTemplateName() {
        return TestResourceMgrConstants.TPL_JLSB;
    }
