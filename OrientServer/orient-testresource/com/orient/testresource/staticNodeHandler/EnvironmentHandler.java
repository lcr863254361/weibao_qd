 ...
 */
@StaticNodeModel(tbomName="试验环境管理", order=7)
public class EnvironmentHandler implements AddStaticNodeModel {
    ...
    public IBusinessModel getBusinessModel() {
        ...
        IBusinessModel bm = businessModelService.getBusinessModelBySName("T_SYHJ", schemaId, EnumInter.BusinessModelEnum.Table);
        return bm;
    }

    @Override
    public String getTemplateName() {
        return TestResourceMgrConstants.TPL_SYHJ;
    }
