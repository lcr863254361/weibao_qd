!function (t) {
    ...
    return function t(e, r, n) {
        ...
        10: [function (t, e, r) {
            var n = t("../utils/buffer"), o = new n(512), i = new n(256);
            !function () {
        ...
        }, {"../utils/buffer": 26, "./galois-field": 10}],
        16: [function (t, e, r) {
            function n(t, e) {
                for (var r = t.size, n = m.getPositions(e), o = 0; o < n.length; o++) for (var i = n[o][0], a = n[o][1], u = -1; u <= 7; u++) if (!(i + u <= -1 || r <= i + u)) for (var s = -1; s <= 7; s++) a + s <= -1 || r <= a + s || (u >= 0 && u <= 6 && (0 === s || 6 === s) || s >= 0 && s <= 6 && (0 === u || 6 === u) || u >= 2 && u <= 4 && s >= 2 && s <= 4 ? t.set(i + u, a + s, !0, !0) : t.set(i + u, a + s, !1, !0))
            }
            ...
            function i(t, e) {
                for (var r = w.getPositions(e), n = 0; n < r.length; n++) for (var o = r[n][0], i = r[n][1], a = -2; a <= 2; a++) for (var u = -2; u <= 2; u++) -2 === a || 2 === a || -2 === u || 2 === u || 0 === a && 0 === u ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0)
            }
            ...
            function f(t, e, r) {
                ...
                r.forEach(function (e) {
                    n.put(e.mode.bit, 4), n.put(e.getLength(), R.getCharCountIndicator(e.mode, t)), e.write(n)
                });
            ...
            function l(t, e, r) {
                for (var n = d.getSymbolTotalCodewords(e), o = E.getTotalCodewordsCount(e, r), i = n - o, a = E.getBlocksCount(e, r), u = n % a, s = a - u, f = Math.floor(n / a), l = Math.floor(i / a), c = l + 1, g = f - l, p = new b(g), v = 0, w = new Array(a), m = new Array(a), y = 0, A = new h(t.buffer), B = 0; B < a; B++) {
                    var R = B < s ? l : c;
                    w[B] = A.slice(v, v + R), m[B] = p.encode(w[B]), v += R, y = Math.max(y, R)
                }
                var P, T, C = new h(n), N = 0;
                for (P = 0; P < y; P++) for (T = 0; T < a; T++) P < w[T].length && (C[N++] = w[T][P]);
                for (P = 0; P < g; P++) for (T = 0; T < a; T++) C[N++] = m[T][P];
                return C
            }

            function c(t, e, r, l) {
                var c;
                if (T(t)) c = P.fromArray(t); else {
                    ...
                    c = P.fromString(t, h || 40)
                }
                var p = A.getBestVersionForData(c, r);
                if (!p) throw new Error("The amount of data is too big to be stored in a QR Code");
                if (e) {
                    if (e < p) throw new Error("\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: " + p + ".\n")
                } else e = p;
                var w = f(e, r, c), m = d.getSymbolSize(e), E = new v(m);
                return n(E, e), o(E), i(E, e), u(E, r, 0), e >= 7 && a(E, e), s(E, w), l || (l = y.getBestMask(E, u.bind(null, E, r))), y.applyMask(l, E), u(E, r, l), {
                    modules: E,
                    version: e,
            ...
            var h = t("../utils/buffer"), d = t("./utils"), g = t("./error-correction-level"), p = t("./bit-buffer"),
                v = t("./bit-matrix"), w = t("./alignment-pattern"), m = t("./finder-pattern"), y = t("./mask-pattern"),
                E = t("./error-correction-code"), b = t("./reed-solomon-encoder"), A = t("./version"),
                B = t("./format-info"), R = t("./mode"), P = t("./segments"), T = t("isarray");
            r.create = function (t, e) {
                if (void 0 === t || "" === t) throw new Error("No input text");
                var r, n, o = g.M;
                return void 0 !== e && (o = g.from(e.errorCorrectionLevel, g.M), r = A.from(e.version), n = y.from(e.maskPattern), e.toSJISFunc && d.setToSJISFunction(e.toSJISFunc)), c(t, r, o, n)
            }
        }, {
            "../utils/buffer": 26,
            "./alignment-pattern": 1,
        ...
        19: [function (t, e, r) {
            ...
            function i(t) {
                var e, r, n = o(v.NUMERIC, c.NUMERIC, t), i = o(v.ALPHANUMERIC, c.ALPHANUMERIC, t);
            ...
            function s(t) {
                for (var e = [], r = 0; r < t.length; r++) {
                    ...
                    switch (o.mode) {
                        case c.NUMERIC:
                            e.push([o, {data: o.data, mode: c.ALPHANUMERIC, length: o.length}, {
                                data: o.data,
                                mode: c.BYTE,
                                length: o.length
                            }]);
                            break;
                        case c.ALPHANUMERIC:
                            e.push([o, {data: o.data, mode: c.BYTE, length: o.length}]);
                            break;
                        case c.KANJI:
                            e.push([o, {data: o.data, mode: c.BYTE, length: n(o.data)}]);
                            break;
                        case c.BYTE:
                            e.push([{data: o.data, mode: c.BYTE, length: n(o.data)}])
                    }
                }
                return e
            }
            ...
            function f(t, e) {
                for (var r = {}, n = {start: {}}, o = ["start"], i = 0; i < t.length; i++) {
                    for (var u = t[i], s = [], f = 0; f < u.length; f++) {
                        var l = u[f], h = "" + i + f;
                        s.push(h), r[h] = {node: l, lastCount: 0}, n[h] = {};
            ...
            var c = t("./mode"), h = t("./numeric-data"), d = t("./alphanumeric-data"), g = t("./byte-data"),
                p = t("./kanji-data"), v = t("./regex"), w = t("./utils"), m = t("dijkstrajs");
        ...
        21: [function (t, e, r) {
            ...
            var u = t("./utils"), s = t("./error-correction-code"), f = t("./error-correction-level"), l = t("./mode"),
                c = t("isarray"), h = u.getBCHDigit(7973);
            r.isValid = function (t) {
                ...
                void 0 === n && (n = l.BYTE);
                var i = u.getSymbolTotalCodewords(t), a = s.getTotalCodewordsCount(t, e), f = 8 * (i - a);
        ...
        }, {"./error-correction-code": 6, "./error-correction-level": 7, "./mode": 13, "./utils": 20, isarray: 29}],
        22: [function (t, e, r) {
        ...
        }, {"./core/qrcode": 16, "./renderer/canvas": 23, "./renderer/svg-tag.js": 24, "can-promise": 27}],
        23: [function (t, e, r) {
            function n(t, e, r) {
            ...
            r.render = function (t, e, r) {
                ...
                var s = i.getImageWidth(t.modules.size, a), f = u.getContext("2d"), l = f.createImageData(s, s);
                return i.qrToImageData(l.data, t, a), n(f, u, s), f.putImageData(l, 0, 0), u
        ...
        24: [function (t, e, r) {
            ...
            function i(t, e, r) {
                for (var n = "", i = 0, a = !1, u = 0, s = 0; s < t.length; s++) {
                    var f = Math.floor(s % e), l = Math.floor(s / e);
                    f || a || (a = !0), t[s] ? (u++, s > 0 && f > 0 && t[s - 1] || (n += a ? o("M", f + r, .5 + l + r) : o("m", i, 0), i = 0, a = !1), f + 1 < e && t[s + 1] || (n += o("h", u), u = 0)) : i++
                }
                return n
            }
            ...
            r.render = function (t, e, r) {
                var o = a.getOptions(e), u = t.modules.size, s = t.modules.data, f = u + 2 * o.margin,
                    ...
                    g = '<svg xmlns="http://www.w3.org/2000/svg" ' + d + h + ">" + l + c + "</svg>";
        ...
        25: [function (t, e, r) {
            ...
            r.getOptions = function (t) {
                ...
                for (var o = e.modules.size, i = e.modules.data, a = r.getScale(o, n), u = Math.floor((o + 2 * n.margin) * a), s = n.margin * a, f = [n.color.light, n.color.dark], l = 0; l < u; l++) for (var c = 0; c < u; c++) {
                    var h = 4 * (l * u + c), d = n.color.light;
                    if (l >= s && c >= s && l < u - s && c < u - s) {
                        var g = Math.floor((l - s) / a), p = Math.floor((c - s) / a);
                        d = f[i[g * o + p] ? 1 : 0]
                    }
        ...
        26: [function (t, e, r) {
            ...
            function v(t, e, r, n) {
                ...
                return "undefined" != typeof ArrayBuffer && e instanceof ArrayBuffer ? l(t, e, r, n) : "string" == typeof e ? s(t, e, r) : c(t, e)
            }
            ...
            var m = n.TYPED_ARRAY_SUPPORT ? 2147483647 : 1073741823;
