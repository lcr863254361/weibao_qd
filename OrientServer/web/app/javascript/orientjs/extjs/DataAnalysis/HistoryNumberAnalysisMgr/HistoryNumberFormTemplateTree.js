 ...
 *
 */
Ext.define('OrientTdm.DataAnalysis.HistoryNumberAnalysisMgr.HistoryNumberFormTemplateTree', {
    extend: 'OrientTdm.Common.Extend.Tree.OrientTree',
    alias: 'widget.HistoryNumberFormTemplateTree',
    config: {
        modelId: '',
        templateId: '',
        modelDesc: null,
    ...
    itemClickListener: function (tree, record, item) {
        ...
        if (topId != '-1' && record.data.parentId == -1) {
            ...
            if (!me.isShowButton) {
                ...
                var checkItemPanel = Ext.create('OrientTdm.DataAnalysis.HistoryNumberAnalysisMgr.HistoryNumbeFormTemplateGrid', {
                    region: 'center',
                    padding: '0 0 0 5',
                    isInst: false,
                    checkTempId: topId,
