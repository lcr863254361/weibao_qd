 ...
 */
Ext.define('OrientTdm.DataAnalysis.CheckTypeManagerGrid', {
    ...
    initComponent: function () {
        ...
        girdPanel.addListener('itemclick', function (grid, record, item, index, e) {
            ...
            var formTemplateCenterPanel = me.up('dataAnalysisDashboard').centerPanel;
            formTemplateCenterPanel.items.each(function (item, index) {
                formTemplateCenterPanel.remove(item);
            });
            var formTemplateMgrPanel = Ext.create('OrientTdm.DataAnalysis.FormTemplateMgrDataAnalysisPanel', {
                region: 'center',
