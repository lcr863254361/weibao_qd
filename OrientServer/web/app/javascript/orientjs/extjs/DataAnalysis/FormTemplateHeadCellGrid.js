...
Ext.define('OrientTdm.DataAnalysis.FormTemplateHeadCellGrid', {
                ...
                if (col.header.indexOf('#') === 0) {
                    ...
                    col.renderer = function (v, p, record) {
                        ...
                        if (v.indexOf('对勾') !== -1) {
                            ...
                            return "<a href='#'  onclick=\"OrientTdm.DataAnalysis.FormTemplateHeadCellGrid.testClick(\'"+url+"\'); return false;\">查看折线图</a>"
