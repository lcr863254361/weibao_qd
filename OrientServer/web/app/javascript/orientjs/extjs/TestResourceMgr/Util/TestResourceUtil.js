    ...
    statics: {
        ...
        getDeviceModelId: function() {
            if(TestResourceUtil.deviceModelId) {
                ...
                var deviceModelId = OrientExtUtil.ModelHelper.getModelId("T_DEVICE", schemaId);
                TestResourceUtil.deviceModelId = deviceModelId;
                return deviceModelId;
            }
        },
        getDeviceStateFilter: function(state) {
            var filter = new CustomerFilter("C_STATE_"+TestResourceUtil.getDeviceModelId(), CustomerFilter.prototype.SqlOperation.In, "", state);
            return filter;
        },
