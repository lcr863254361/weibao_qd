 ...
 */
Ext.define('OrientTdm.SparePartsMgr.EnterResearchTestMgr.EnterResearchTestGrid',{
    extend:'OrientTdm.Common.Extend.Panel.OrientPanel',
    alias:'widget.enterResearchTestGrid',
    config:{
        schemaId:TDM_SERVER_CONFIG.WEI_BAO_SCHEMA_ID,
        templateName:TDM_SERVER_CONFIG.TPL_DEVICE_INST_RESEARCH,
    ...
    initComponent:function(){
        ...
        var modelGrid=Ext.create('OrientTdm.Common.Extend.Grid.OrientModelGrid',{
            ...
            queryUrl: serviceName + "/spareParts/getTroubleDeviceData.rdm?deviceInstId="+me.deviceInstId+"&isTrouble="+false,
