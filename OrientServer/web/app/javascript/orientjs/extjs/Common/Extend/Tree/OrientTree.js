...
Ext.define('OrientTdm.Common.Extend.Tree.OrientTree', {
    ...
    initComponent: function () {
        ...
        me.on("itemclick", me.itemcontextmenu, me);
    },
    initEvents: function () {
        var me = this;
        me.callParent();
     ...
     * 默认刷新方法，刷新当前选中的节点
     */
    doRefresh: function (selectedNode) {
        var me = this;
        var selectedNode = selectedNode || this.getSelectionModel().getSelection()[0];
        me.getStore().load({
            node: selectedNode,
