...
Ext.define('OrientTdm.Common.Extend.Form.Field.SimpleColumnDescForSelector', {
    ...
    _openSelectorWin: function () {
        ...
        if (!Ext.isEmpty(selector)) {
            ...
            if ('1' == selectortype) {
                ...
                var userSelectorPanel = me._createChooseUserPanel(selectedValue, filterType, filterValue, multiSelect);
    ...
    _createChooseUserPanel: function (selectedValue, filterType, filterValue, multiSelect) {
        var me = this;
