...
Ext.define('OrientTdm.DestroyRepairTemplateMgr.DestroyCenterPanel', {
    alias: 'widget.destroyCenterPanel',
    extend: 'OrientTdm.Common.Extend.Panel.OrientTabPanel',
    requires: [
        "OrientTdm.DestroyRepairTemplateMgr.util.GanttControlledPanelHelper"
    ],
    config: {},
    ...
    tabChanged: function (tabPanel, newCard, oldCard) {
        ...
        var panel = GanttControlledPanelHelper.getPanelByTitle(newCard.title, {
            region: 'center',
