        ...
        _updateFileList: function () {
            ...
            g.each(j.files, function (q, p) {
                ...
                m.append('<tr class="ui-state-default plupload_file" id="' + p.id + '"><td class="plupload_cell plupload_file_name"><span>' + p.name + '</span></td>' +
                    '<td class="plupload_cell plupload_file_status"><select class="plupload_cell plupload_file_status" id="' + secrecyId + '"><option value ="公开" >公开</option><option value ="内部" >内部</option><option value ="秘密">秘密</option><option value ="机密">机密</option></select></td>' +
