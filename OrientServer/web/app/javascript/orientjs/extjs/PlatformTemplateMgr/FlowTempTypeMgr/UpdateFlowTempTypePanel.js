 ...
 */
Ext.define('OrientTdm.PlatformTemplateMgr.FlowTempTypeMgr.UpdateFlowTempTypePanel', {
    extend: 'OrientTdm.Common.Extend.Form.OrientForm',
    alias: 'widget.updateFlowTempTypePanel',
    actionUrl: serviceName + '/FlowTempMgr/updateFlowTempTypeData.rdm',
    config: {
    ...
    initComponent: function () {
        ...
        me.actionUrl = serviceName + '/FlowTempMgr/updateFlowTempTypeData.rdm?modelId=' + me.modelId + '&flowTempTypeId=' + me.flowTempTypeId;
        Ext.apply(me, {
            items: [
                {
                    xtype: 'panel',
