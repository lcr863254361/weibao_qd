 ...
 */
Ext.define('OrientTdm.FormTemplateMgr.FormPanel.AddCheckTypeFormPanel', {
    extend: 'OrientTdm.Common.Extend.Form.OrientForm',
    alias: 'widget.addCheckTypeFormPanel',
    ...
    initComponent: function () {
        ...
        me.actionUrl = serviceName + '/modelData/saveModelData.rdm?modelId=' + me.modelId;
            // var saveUrl=serviceName+'/formTemplate/saveCheckTypeData.rdm?modelId='+modelId;
            Ext.apply(me, {
                items: [
                    {
                        xtype: 'panel',
                            ...
                            items: [
                                {
                                    ...
                                    columnName: 'C_CHECK_NAME_' + me.modelId,
                                    allowBlank: false,
                                    editable: true,
                                    hidden: false,
                                    flex: 1
