Ext.define('OrientTdm.CollabDev.Designing.AuditSetting.AuditDetailSettingGrid', {
    extend: 'OrientTdm.Common.Extend.Grid.OrientGrid',
    alias: 'widget.auditDetailSettingGrid',
    requires: [
    ...
    createStore: function () {
        ...
        var retVal = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    "read": serviceName + '/auditSettings/listAuditDetail.rdm',
                    "update": serviceName + '/auditSettings/updateAuditDetail.rdm'
                },
                reader: {
                    type: 'json',
