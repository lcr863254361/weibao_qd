Ext.define("OrientTdm.CollabDev.Designing.RightSetting.South.AssignUserGrid", {
    extend: 'OrientTdm.SysMgr.RoleMgr.Common.AssignGrid',
    //查询url
    queryUrl: serviceName + '/collabRightSetting/usersToAssign.rdm',
    //保存url
    saveUrl: serviceName + '/collabRightSetting/saveAssignedUsers.rdm',
    requires: [
