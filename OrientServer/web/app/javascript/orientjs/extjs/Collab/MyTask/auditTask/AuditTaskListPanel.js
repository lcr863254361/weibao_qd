...
Ext.define('OrientTdm.Collab.MyTask.auditTask.AuditTaskListPanel', {
    ...
    renderName: function(value, p, record) {
        ...
        return '<span href="javascript:;" class="taskSpan" onclick="OrientTdm.Collab.MyTask.auditTask.AuditTaskListPanel.showDetail(\''+me.getId()+'\''+',\''+recordId+'\');">'+value+'</span>';
    },
