 ...
 */
Ext.define('OrientTdm.ConsumeMaterialMgr.ConsumeTypeMgr.AddConsumeTypePanel',{
    extend:'OrientTdm.Common.Extend.Form.OrientForm',
    alias:'widget.addConsumeTypePanel',
    ...
    initComponent:function(){
        ...
        // var saveUrl=serviceName+'/ConsumeMaterialMgr/addConsumeTypeData.rdm?modelId='+modelId;
        Ext.apply(me,{
            items:[
                {
                    xtype:'panel',
