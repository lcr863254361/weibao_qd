Ext.define('OrientTdm.DepthDesityMgr.Center.DepthDesityShowRegion', {
    ...
    initModelDataByNode: function (treeNode) {
        ...
        if (tbomModels.length == 0) {
            ...
            Ext.each(tbomModels, function (tbomMode) {
                ...
                var modelGrid;
                if (tbomMode.modelName === '深度密度管理' && treeNode.raw.level === 2) {
                    initParams.depthDesityTypeId=treeNode.raw.idList[0];
                    initParams.seaAreaName=treeNode.raw.text;
                    modelGrid = Ext.create("OrientTdm.DepthDesityMgr.DepthDesityGrid", initParams);
