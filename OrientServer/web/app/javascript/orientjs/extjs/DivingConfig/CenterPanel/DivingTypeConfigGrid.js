 ...
 */
Ext.define('OrientTdm.DivingConfig.CenterPanel.DivingTypeConfigGrid', {
    extend: 'OrientTdm.Common.Extend.Panel.OrientPanel',
    alias: 'widget.divingTypeConfigGrid',
    config: {
        schemaId: TDM_SERVER_CONFIG.WEI_BAO_SCHEMA_ID,
        templateName: TDM_SERVER_CONFIG.TPL_DIVING_TYPE,
        modelName: TDM_SERVER_CONFIG.DIVING_TYPE
    },
