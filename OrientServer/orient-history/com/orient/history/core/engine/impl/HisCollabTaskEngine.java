 ...
 */
@Component
public class HisCollabTaskEngine extends AbstractHisTaskEngine {
    ...
    public HisTaskInfo doSaveHisTaskInfo(String taskId) {
        ...
        //初始化基本信息
        HisTaskHelper.getInstance().initWorkFlowTaskBaseInfo(task, taskInfo, HisTaskTypeConstants.COLLAB_TASK, taskName);
